...
QuadMesh.c/h: Creates a flat open surface mesh of quadrilaterals for you. It has functions to create and draw a mesh, 
create normal vectors etc. See main.c for an example of how to use these functions. This is a good example of polygon 
mesh code and we will be learning more about polygon mesh data structures in a couple of weeks. 
